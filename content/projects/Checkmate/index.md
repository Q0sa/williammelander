...
summary = """Puzzle game made for Android using Unity, based off  "Lara Croft Go" and adding Chess to the mix!"""
...
heavily wounded, you barely manage to escape from the battle and are now unable to walk diagonally. you will have to navigate a treacherous path through ancient ruins while outsmarting the Rubrum army hot on your heels. <br>
